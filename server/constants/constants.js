...
export const DOMAIN = 'room.brokard-trade.ru';
...
export const FINNHUB_API_KEY_PROD = 'ccrf8d2ad3i6utlaigugccrf8d2ad3i6utlaigv0';
...
export const DEV_MAIL_CREDENTIALS = {
    login: 'megatradeoff@gmail.com',
    password: 'crezvqbjtkvxlhvz'
};
